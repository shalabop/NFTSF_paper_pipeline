...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff_cond/alanine_phi_100_50.%j.out
#SBATCH --error=logs/tsdiff_cond/alanine_phi_100_50.%j.err
...
mkdir -p checkpoints_100_50/tsdiff_cond
mkdir -p results/tsdiff_cond/checkpoints_100_50
which python
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/alanine_phi_100_50.yaml \
        --out_dir checkpoints_100_50/tsdiff_cond/alanine_phi

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/alanine_phi_cond_100_50.yaml  \
        --dataset_path gluonts_datasets/alanine_phi \
        --out results/tsdiff_cond/alanine_phi_100_50.npz