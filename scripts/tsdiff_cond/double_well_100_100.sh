...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff_cond/double_well_100_100.%j.out
#SBATCH --error=logs/tsdiff_cond/double_well_100_100.%j.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/double_well_100_100.yaml \
        --out_dir checkpoints_100_100/tsdiff_cond/double_well