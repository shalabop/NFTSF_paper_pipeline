#!/usr/bin/env bash
#SBATCH --job-name=DWm2525TSFdiff
...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff_cond/double_well_with_memory_25_25.%j.out
#SBATCH --error=logs/tsdiff_cond/double_well_with_memory_25_25.%j.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/double_well_with_memory_25_25.yaml \
        --out_dir checkpoints_25_25/tsdiff_cond/double_well_with_memory