#!/usr/bin/env bash
#SBATCH --job-name=DWTSFdiffcondforecast
...
#SBATCH --gres=gpu:2
#SBATCH --mem=32G
#SBATCH --output=logs/tsdiff_cond/double_well_forecast.%j.out
#SBATCH --error=logs/tsdiff_cond/double_well_forecast.%j.err
