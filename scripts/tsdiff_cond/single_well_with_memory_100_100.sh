...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff_cond/single_well_with_memory_100_100.%j.out
#SBATCH --error=logs/tsdiff_cond/single_well_with_memory_100_100.%j.err
...
mkdir -p checkpoints_100_100/tsdiff_cond
mkdir -p results/tsdiff_cond/checkpoints_100_100
which python
...
python train/TSDiff/train_cond_tsdiff.py \
        --dataset_path gluonts_datasets/single_well_with_memory \
        --config configs/tsdiff_cond_train/single_well_with_memory_100_100.yaml \
        --out_dir checkpoints_100_100/tsdiff_cond/single_well_with_memory