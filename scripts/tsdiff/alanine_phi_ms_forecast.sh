...
#SBATCH --gres=gpu:2
#SBATCH --mem=32G
#SBATCH --output=logs/tsdiff/alanine_phi_mse.%j.out
#SBATCH --error=logs/tsdiff/alanine_phi_mse.%j.err
...
python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/alanine_phi_mse_025.yaml  \
        --dataset_path gluonts_datasets/alanine_phi \
        --out results/tsdiff_mse/alanine_phi_mse_025.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/alanine_phi_mse_01.yaml  \
        --dataset_path gluonts_datasets/alanine_phi \
        --out results/tsdiff_mse/alanine_phi_mse_01.npz