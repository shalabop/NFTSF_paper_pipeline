...
python train/TSDiff/train_tsdiff.py \
        ...
        --out_dir checkpoints_50_50_dummy/tsdiff/single_well

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_mse_03_50_50.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_mse/single_well_mse_03_50_50.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/single_well_q_4_50_50.yaml  \
        --dataset_path gluonts_datasets/single_well \
        --out results/tsdiff_q/single_well_q_4_50_50.npz