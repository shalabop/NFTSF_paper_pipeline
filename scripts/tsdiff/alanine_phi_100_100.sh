...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff/alanine_phi_100_100.%j.out
#SBATCH --error=logs/tsdiff/alanine_phi_100_100.%j.err
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/alanine_phi_100_100.yaml \
        --out_dir checkpoints_100_100/tsdiff/alanine_phi
