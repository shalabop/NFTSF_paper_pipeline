...
python train/TSDiff/train_tsdiff.py \
        ...
        --out_dir checkpoints_25_25_dummy/tsdiff/double_well

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/double_well_mse_03_25_25.yaml  \
        --dataset_path gluonts_datasets/double_well \
        --out results/tsdiff_mse/double_well_mse_03_25_25.npz
