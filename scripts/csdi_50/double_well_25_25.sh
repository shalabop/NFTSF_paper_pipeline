...
mkdir -p results/csdi_with_early_stopping_50
mkdir -p results/csdi_with_early_stopping_50/alanine_phi_50_50
...
python train/CSDI/train_csdi_with_early_stopping.py \
    ...
    --out    checkpoints_25_25/csdi_with_early_stopping_50/double_well \
    --device cuda:0