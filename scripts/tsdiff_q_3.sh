...
python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/double_well_q_2_25_25.yaml  \
        --dataset_path gluonts_datasets/double_well \
        --out results/tsdiff_q/double_well_q_2_25_25.npz

python eval/TSDiff/forecast_tsdiff.py   \
        --config configs/tsdiff_forecast/double_well_q_2_50_50.yaml  \
        --dataset_path gluonts_datasets/double_well \
        --out results/tsdiff_q/dowuble_well_q_2_50_50.npz