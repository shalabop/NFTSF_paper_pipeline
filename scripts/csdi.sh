...
#SBATCH --mem=32G
#SBATCH --output=logs/csdi.%j.out
#SBATCH --error=logs/csdi.%j.err
...
python eval/CSDI/forecast_csdi.py \
    ...
    --ckpt   checkpoints_25_25/csdi_with_early_stopping/single_well/model.pth \
    --out    results/csdi_with_early_stopping/single_well_25_25.npz \
    --device cuda:0