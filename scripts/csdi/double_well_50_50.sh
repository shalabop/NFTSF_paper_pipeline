...
mkdir -p checkpoints_25_25_dummy/csdi_with_early_stopping/alanine_phi
...
python train/CSDI/train_csdi.py \
    --config configs/csdi_train/double_well_50_50.yaml \
    --input  data/double_well_train.npz \
    --out    checkpoints_50_50_dummy/csdi/double_well \
    --device cuda:0

python eval/CSDI/forecast_csdi.py \
    --config configs/csdi_train/double_well_50_50.yaml \
    --input  data/double_well_test.npz \
    --ckpt   checkpoints_50_50_dummy/csdi_with_early_stopping/double_well/model.pth \
    --out    results/csdi_with_early_stopping/double_well_50_50.npz \
    --device cuda:0