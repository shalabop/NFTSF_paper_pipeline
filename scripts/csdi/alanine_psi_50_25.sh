...
mkdir -p results/csdi/alanine_psi_50_25
#mkdir -p logs/csdi/alanine_psi
mkdir -p checkpoints_50_25/csdi/
...
python train/CSDI/train_csdi.py \
    --config configs/csdi_train/alanine_psi_50_25.yaml \
    --input  DATA/alanine_psi_train.npz \
    --out    checkpoints_50_25/csdi/alanine_psi \
    --device cuda:0
...
python eval/CSDI/forecast_csdi.py \
    ...
    --ckpt   checkpoints_50_25/csdi/alanine_psi/model.pth \
    --out    results/csdi/alanine_psi_50_25.npz \
    --device cuda:0