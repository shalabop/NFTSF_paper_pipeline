#!/usr/bin/env bash
#SBATCH --job-name=DWCSDmemory25_25
...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/csdi/double_well_with_memory_25_25.%j.out
#SBATCH --error=logs/csdi/double_well_with_memory_25_25.%j.err

mkdir -p results/csdi/double_well
#mkdir -p logs/csdi/double_well
mkdir -p checkpoints_25_25/csdi/double_well_with_memory
...
python train/CSDI/train_csdi.py \
    ...
    --out    checkpoints_25_25/csdi/double_well_with_memory \
    --device cuda:0
