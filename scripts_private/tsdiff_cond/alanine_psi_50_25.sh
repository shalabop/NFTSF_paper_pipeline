...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/alanine_psi_50_25.%j.out
#SBATCH --error=logs/tsdiff_cond/alanine_psi_50_25.%j.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/alanine_psi_50_25.yaml \
        --out_dir checkpoints_50_25/tsdiff_cond/alanine_psi

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/alanine_psi_cond_50_25.yaml  \
        --dataset_path gluonts_datasets/alanine_psi \
        --out results/tsdiff_cond/alanine_psi_50_25.npz