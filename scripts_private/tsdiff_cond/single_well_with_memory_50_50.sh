...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff_cond/single_well_with_memory_50_50.%j.out
#SBATCH --error=logs/tsdiff_cond/single_well_with_memory_50_50.%j.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/single_well_with_memory_50_50.yaml \
        --out_dir checkpoints_50_50/tsdiff_cond/single_well_with_memory