...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --output=logs/tsdiff_cond/single_well_100_100.%j.out
#SBATCH --error=logs/tsdiff_cond/single_well_100_100.%j.err
...
mkdir -p results/tsdiff_cond/checkpoints_010_100
which python
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/single_well_100_100.yaml \
        --out_dir checkpoints_100_100/tsdiff_cond/single_well