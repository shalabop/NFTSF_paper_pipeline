...
python train/RATD/train_tcn.py --config configs/tcn/double_well.yaml

python train/RATD/retrieval_builder.py --config configs/tcn/double_well.yaml --type encode

python train/RATD/retrieval_builder.py --config configs/tcn/double_well.yaml --type retrieval

python train/RATD/train_ratd.py --config configs/ratd/double_well.yaml

python eval/RATD/forecast_ratd.py --config configs/ratd/double_well.yaml
