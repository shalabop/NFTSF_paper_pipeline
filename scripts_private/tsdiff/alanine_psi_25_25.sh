...
#SBATCH --error=logs/tsdiff/alanine_psi_25_25.%j.err
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/alanine_psi_25_25.yaml \
        --out_dir checkpoints_25_25/tsdiff/alanine_psi
