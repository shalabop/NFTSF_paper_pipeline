...
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --output=logs/tsdiff/alanine_psi.%j.out
...
python train/TSDiff/train_tsdiff.py \
        ...
        --config configs/tsdiff_train/alanine_psi.yaml \
        --out_dir checkpoints/tsdiff/alanine_psi
