...
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --output=logs/tsdiff_cond/alanine_psi_100_50.%j.out
#SBATCH --error=logs/tsdiff_cond/alanine_psi_100_50.%j.err
...
python train/TSDiff/train_cond_tsdiff.py \
        ...
        --config configs/tsdiff_cond_train/alanine_psi_100_50.yaml \
        --out_dir checkpoints_100_50/tsdiff_cond/alanine_psi

python eval/TSDiff/forecast_tsdiff_cond.py   \
        --config configs/tsdiff_forecast/alanine_psi_cond_100_50.yaml  \
        --dataset_path gluonts_datasets/alanine_psi \
        --out results/tsdiff_cond/alanine_psi_100_50.npz