...
def normalize_all(datatype, out, data_path, train_test_split=None, train_val_split=None, train_size=None):
...
if __name__ == '__main__':
    ...
    normalize_all(datatype=args.data_type,out=args.out_path, data_path=args.data_path, train_test_split=args.train_test_split, train_val_split=args.train_val_split, train_size=args.train_size)
    print("==="*20)
