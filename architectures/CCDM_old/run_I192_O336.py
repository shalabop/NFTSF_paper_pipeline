...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default=torch.device("cuda:5" if torch.cuda.is_available() else "cpu"), help='device')
    ...
    # forecasting task
    parser.add_argument('--cont_len', type=int, default=192, help='context sequence length')
    ...
    parser.add_argument('--cont_hidden_dim', type=int, default=512, help='hidden size of context, options:[128, 256, 512, 768]')
    parser.add_argument('--pred_hidden_dim', type=int, default=512, help='hidden size of predition, options:[128, 256, 512, 768]')
    parser.add_argument('--step_hidden_dim', type=int, default=512, help='hidden size of diffusion step')
    parser.add_argument('--time_hidden_dim', type=int, default=512, help='hidden size of timestamp')
    ...
    if args.status == "train":
        ...
        model.test(best_epoch=29, n_samples=20, is_out=False)
