...
def get_dataloader_md(npz_path, context_length, prediction_length,
    ...
    train_dataset = MDNsDiffDataset(train_ctx, train_fcst, mean, std, normalization)
    val_dataset   = MDNsDiffDataset(val_ctx,val_fcst,mean, std, normalization)
    test_dataset  = MDNsDiffDataset(test_ctx,test_fcst,mean, std, normalization)
