...
CKPT_PATH = "lightning_logs/version_42826943/best_checkpoint.ckpt"

with open("configs/guidance/guidance_solar.yaml") as f:
...
plt.xlim(6900, 7040)
plt.tight_layout()
plt.savefig("solar_forecast_ci90.png", dpi=150)
plt.close()
