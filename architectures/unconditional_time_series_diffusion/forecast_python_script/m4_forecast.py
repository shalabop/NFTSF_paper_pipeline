...
CKPT_PATH = "lightning_logs/version_42829291/best_checkpoint.ckpt"

with open("configs/guidance/guidance_m4.yaml") as f:
...
plt.xlim(600, 760)
plt.tight_layout()
plt.savefig("m4_forecast_ci90.png", dpi=150)
plt.close()
